...
# TMC PR Line Counter
# 
# Purpose: Counts implementation lines in TMC feature branches to ensure PRs stay within size limits
# Usage: ./tmc-pr-line-counter.sh -c <branch-name> [-b <base-branch>]
# 
# This script excludes generated files, tests, and config files to focus on reviewable code.
# Target: Keep implementation under 700 lines for optimal review
#
