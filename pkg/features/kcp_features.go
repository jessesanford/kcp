...
const (
	...
	// TMC enables the Transparent Multi-Cluster functionality
	// owner: @jessesanford
	// alpha: v0.1
	TMC featuregate.Feature = "TMC"

	// TMCClusterRegistration enables TMC cluster registration controller
	// owner: @jessesanford
	// alpha: v0.1
	TMCClusterRegistration featuregate.Feature = "TMCClusterRegistration"
)
