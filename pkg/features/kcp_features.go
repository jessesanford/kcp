...
const (
	...
	// owner: @jessesanford
	// alpha: v0.1
	// Enables TMC (Transparent Multi-Cluster) functionality including workload placement,
	// cluster management, and multi-cluster synchronization. This is the master feature
	// flag that controls all TMC components.
