...
// SessionReference references a placement session
type SessionReference struct {
	// Name is the name of the placement session
	Name string `json:"name"`

	// Namespace is the namespace of the placement session
	Namespace string `json:"namespace"`

	// UID is the unique identifier of the placement session
	// +optional
	UID string `json:"uid,omitempty"`

	// SessionID is the session identifier across clusters
	// +optional
...
// WorkloadReference references a workload
...
// ConflictType defines the types of placement conflicts
// +kubebuilder:validation:Enum=ResourceConflict;ConstraintConflict;PolicyConflict;AffinityConflict
type ConflictType string

const (
	// ConflictTypeResourceConflict represents resource-based conflicts
	ConflictTypeResourceConflict ConflictType = "ResourceConflict"
	// ConflictTypeConstraintConflict represents constraint-based conflicts
	ConflictTypeConstraintConflict ConflictType = "ConstraintConflict"
	// ConflictTypePolicyConflict represents policy-based conflicts
	ConflictTypePolicyConflict ConflictType = "PolicyConflict"
	// ConflictTypeAffinityConflict represents affinity-based conflicts
	ConflictTypeAffinityConflict ConflictType = "AffinityConflict"
)

// PlacementReference references a placement decision
type PlacementReference struct {
	...
	// ClusterName is the target cluster for the placement
	// +optional
