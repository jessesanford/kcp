...
// ConstraintEvaluation represents an evaluation of a placement constraint
type ConstraintEvaluation struct {
	// ConstraintName is the name of the constraint
	ConstraintName string `json:"constraintName"`

	// Satisfied indicates whether the constraint was satisfied
	Satisfied bool `json:"satisfied"`

	// Reason provides the reason for the constraint evaluation result
	// +optional
