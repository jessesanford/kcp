...
// NewInformerFunc takes kcpcluster.ClusterInterface and time.Duration to return a kcpcache.ScopeableSharedIndexInformer.
type NewInformerFunc func(kcpcluster.ClusterInterface, time.Duration) kcpcache.ScopeableSharedIndexInformer
...
// NewScopedInformerFunc takes kcpversioned.Interface and time.Duration to return a SharedIndexInformer.
type NewScopedInformerFunc func(kcpversioned.Interface, time.Duration) cache.SharedIndexInformer
