...
type TmcV1alpha1Interface interface {
	...
	WorkloadPlacementsGetter
}

// TmcV1alpha1Client is used to interact with features provided by the tmc.kcp.io group.
...
func (c *TmcV1alpha1Client) WorkloadPlacements(namespace string) WorkloadPlacementInterface {
	return newWorkloadPlacements(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) error {
	gv := tmcv1alpha1.SchemeGroupVersion
