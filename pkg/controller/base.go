...
// ManagerMetrics provides basic metrics collection for controllers
type ManagerMetrics struct {
	reconcileTotal *prometheus.CounterVec
}

// NewManagerMetrics creates a new ManagerMetrics instance
...
// Controller provides common controller patterns and functionality
// that can be shared across all KCP controllers. This includes work queue
...
// used across all KCP controllers. It follows KCP architectural patterns
...
// This provides the foundation for all KCP controllers with consistent patterns
