...
// It follows KCP's dependency injection pattern. Algorithms must be registered separately.
func NewEngine() *Engine {
	...
	// Algorithms will be registered by consumers of this package
	// This foundation provides the framework for pluggable algorithms
