...
// ManagerMetrics provides prometheus metrics for controller management.
...
// NewManagerMetrics creates a new ManagerMetrics instance with default prometheus metrics.
