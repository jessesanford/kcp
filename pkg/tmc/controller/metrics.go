...
// NoOpMetricsRecorder provides a no-op implementation for when metrics are disabled.
...
// RecordReconcile implements MetricsRecorder.RecordReconcile (no-op)
func (m *NoOpMetricsRecorder) RecordReconcile(controller, result string) {
