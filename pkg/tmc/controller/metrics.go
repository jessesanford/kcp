...
// ManagerMetrics provides Prometheus metrics for TMC controller manager.
type ManagerMetrics struct {
	// controllersTotal tracks the total number of controllers
	controllersTotal prometheus.Gauge
	
	// controllersHealthy tracks the number of healthy controllers  
	controllersHealthy prometheus.Gauge
	
	// reconcileTotal tracks reconciliation attempts by controller and result
	reconcileTotal *prometheus.CounterVec
}

// NewManagerMetrics creates new metrics for the controller manager.
