...
type ApiresourceV1alpha1ClusterScoper interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.ApiresourceV1alpha1Interface
}

// ApiresourceV1alpha1ClusterClient is used to interact with features provided by the apiresource.kcp.io group.
type ApiresourceV1alpha1ClusterClient struct {
	clientCache kcpclient.Cache[*kcpv1alpha1.ApiresourceV1alpha1Client]
}

func (c *ApiresourceV1alpha1ClusterClient) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.ApiresourceV1alpha1Interface {
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ApiresourceV1alpha1ClusterClient, error) {
	cache := kcpclient.NewCache(c, h, &kcpclient.Constructor[*kcpv1alpha1.ApiresourceV1alpha1Client]{
...
func setConfigDefaults(config *rest.Config) {
	gv := kcpapiresourcev1alpha1.SchemeGroupVersion
