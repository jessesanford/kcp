...
import (
	...
	kcpv1alpha1 "github.com/kcp-dev/kcp/sdk/client/clientset/versioned/typed/apiresource/v1alpha1"
)
...
// or scope down to one cluster and return a kcpv1alpha1.NegotiatedAPIResourceInterface.
type NegotiatedAPIResourceClusterInterface interface {
	Cluster(logicalcluster.Path) kcpv1alpha1.NegotiatedAPIResourceInterface
	List(ctx context.Context, opts v1.ListOptions) (*kcpapiresourcev1alpha1.NegotiatedAPIResourceList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	NegotiatedAPIResourceClusterExpansion
}

type negotiatedAPIResourcesClusterInterface struct {
	clientCache kcpclient.Cache[*kcpv1alpha1.ApiresourceV1alpha1Client]
}

// Cluster scopes the client down to a particular cluster.
func (c *negotiatedAPIResourcesClusterInterface) Cluster(clusterPath logicalcluster.Path) kcpv1alpha1.NegotiatedAPIResourceInterface {
...
func (c *negotiatedAPIResourcesClusterInterface) List(ctx context.Context, opts v1.ListOptions) (*kcpapiresourcev1alpha1.NegotiatedAPIResourceList, error) {
...
func (c *negotiatedAPIResourcesClusterInterface) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
