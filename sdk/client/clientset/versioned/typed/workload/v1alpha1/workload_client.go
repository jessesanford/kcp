...
type WorkloadV1alpha1Interface interface {
	...
	WorkloadStatusAggregationsGetter
}
...
func (c *WorkloadV1alpha1Client) WorkloadStatusAggregations() WorkloadStatusAggregationInterface {
	return newWorkloadStatusAggregations(c)
}
